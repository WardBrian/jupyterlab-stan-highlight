...
CodeMirror.defineSimpleMode("stan", {
  ...
  start: [
    ...
    //types 
    {
      regex: /(\b)(int|real|complex|vector|array|simplex|unit_vector|ordered|positive_ordered|row_vector|matrix|corr_matrix|cov_matrix|cholesky_factor_cov|cholesky_factor_corr|void)(\b)/,
      token: [null, "def", null]
    },
    {
